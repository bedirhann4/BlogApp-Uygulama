                ...
                <div class="card-body">
                    <form action="create.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea style="background: #242026; color: #fff;" name="aciklama" id="aciklama" class="form-control"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="resimurl" class="form-label">Resim</label>
                            <input type="" class="form-control" name="resimurl" id="resimurl">
                        </div>
